! function(e, t) {
	...
	return function(e) {
		...
		function a(e) {
			return e && M.test(e) ? e.replace(C, function(e) {
				return w[e]
			}) : e
		}
		var l = function() {
			...
			k = function() {
				...
				return l(e, [{
					...
					value: function(e) {
						...
						try {
							...
							var i = m.ds,
								o = e.avatar,
								a = m.params;
							m.params = a + "d=" + (i.indexOf(o) > -1 ? o : "mm"), m.hide = "hide" === o, b.url = decodeURI((e.path || location.pathname).replace(/index\.(html|htm)$/, "")), e.guest_info = (e.guest_info || x).filter(function(e) {
								return x.indexOf(e) > -1
							});
							var l = Number(e.pageSize || 10);
							e.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l;
							var s = AV;
							...
							if (s.init({
								...
								for (var d = document.querySelectorAll(".valine-comment-count"), p = 0, h = d.length; p < h; p++) ! function(e, n) {
									var r = d[e];
									if (r) {
										var i = r.getAttribute("data-xid");
										t.C(i).then(function(e) {
											r.innerText = e
										})
									}
								}(p);
							var f = e.el || null;
							if (!(f = "[object HTMLDivElement]" === {}.toString.call(f) ? f : document.querySelectorAll(f)[0] || null)) throw 99;
							if (f) {
								t.el = f, t.el.classList.add("valine");
								var v = {
									...
									g = e.guest_info.map(function(e) {
										return v[e]
									}),
									k = e.placeholder || "",
									w = '<div class="vwrap"><div class="vheader item' + g.length + '">' + g.join("") + '</div><div class="vedit"><textarea class="veditor vinput" placeholder="' + k + '"></textarea></div><div class="vcontrol"><div class="col col-60" title="MarkDown is Support"><a href="https://segmentfault.com/markdown" target="_blank">MarkDown</a> is support, <a href="https://valine.js.org" target="_blank" >powered by Valine</a><label for="argee" style="display:none;"><input type="checkbox" id="argee">I\'m not a Robot!</label></div><div class="col col-40 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><ul class="vlist"></ul><div class="vempty" style="display:none;"></div><div class="vpage txt-center" ></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v1.1.8-rc2</div></div>';
								t.el.innerHTML = w;
								var O = t.el.querySelector(".vempty");
								t.nodata = {
									show: function(e) {
										return O.innerHTML = e || t.locale.tips.sofa, O.setAttribute("style", "display:block;"), t
									},
									hide: function() {
										return O.setAttribute("style", "display:none;"), t
									}
								};
								var S = document.createElement("li");
								S.setAttribute("class", "vloading"), S.innerHTML = '<div class="loading loading--double"></div>';
								var $ = t.el.querySelector(".vlist");
								t.loading = {
									show: function(e) {
										var n = $.querySelectorAll("li");
										return e ? $.insertBefore(S, n[0]) : $.appendChild(S), t.nodata.hide(), t
									},
									hide: function() {
										var e = $.querySelector(".vloading");
										return e && $.removeChild(e), 0 === $.querySelectorAll(".vcard").length && t.nodata.show(), t
									}
								};
								var A = t.el.querySelector(".vmark");
								t.alert = {
									show: function(e) {
										A.innerHTML = '<div class="valert txt-center"><div class="vtext">' + (e && e.text || 1) + '</div><div class="vbtns"></div></div>';
										var n = A.querySelector(".vbtns"),
										...
										if (n.innerHTML = "" + r + (e && e.type && i), _.on("click", A.querySelector(".vcancel"), function(e) {
												t.alert.hide()
											}), A.setAttribute("style", "display:block;"), e && e.type) {
											var o = A.querySelector(".vsure");
									...
									hide: function() {
										return A.setAttribute("style", "display:none;"), t
									}
								}
							}
							t.el && t.bind(e)
					...
					value: function(e) {
						...
						var n = "";
						return 101 == e ? t.nodata.show() : n = "number" == typeof e ? "Code " + e + ": " + (t.locale.error[e] || e) : e, t.el && t.nodata.show('<pre style="text-align:left;">' + n + "</pre>"), console, t
					}
				}, {
					key: "installLocale",
					value: function(e, t) {
						var n = this;
						return y[e] = JSON.stringify(Object.keys(y["zh-cn"])) == JSON.stringify(Object.keys(t)) ? t : void 0, n.locale = y[e] || y["zh-cn"], n
					}
				}, {
					key: "bind",
					value: function(e) {
						var t = this,
							n = function n() {
								...
								t.loading.show();
								var l = t.Q(b.url);
								l.limit(o), l.skip((i - 1) * o), l.find().then(function(e) {
									for (var l = e.length, s = 0; s < l; s++) r(e[s], !0);
						...
						for (var r = function(e, n) {
								...
								var o = m.hide ? "" : '<img class="vimg" src=\'' + (m.cdn + (0, c.default)(e.get("mail")) + m.params) + "'>",
									...
									l = '<span class="vsys">' + a.browser + " " + a.version + "</span>",
									s = '<span class="vsys">' + a.os + " " + a.osVersion + "</span>",
									u = "",
									d = e.get("link") || (e.get("mail") ? "mailto:" + e.get("mail") : "");
								u = d ? '<a class="vname" rel="nofollow" href="' + d + '" target="_blank" >' + e.get("nick") + "</a>" : '<span class="vname">' + e.get("nick") + "</span>", r.innerHTML = o + '<section><div class="vhead">' + u + " " + l + " " + s + '</div><div class="vcontent">' + e.get("comment") + '</div><div class="vfooter"><span class="vtime">' + (0, v.default)(e.get("createdAt"), t.locale) + "</span><span rid='" + e.id + "' at='@" + e.get("nick") + "' mail='" + e.get("mail") + '\' class="vat">' + t.locale.ctrl.reply + "</span><div></section>";
								...
								rid: "",
								rmail: ""
							}, s = e.guest_info, u = {}, p = function(e) {
								_.on("click", e, function(t) {
									var n = e.getAttribute("at"),
										r = e.getAttribute("rid"),
										i = e.getAttribute("mail");
									l.at = o(n), l.rid = r, l.rmail = i, u.comment.value = n + " ", u.comment.focus()
								})
							}, f = {
								veditor: "comment"
							}, x = 0, y = s.length; x < y; x++) f["v" + s[x]] = s[x];
						for (var k in f) f.hasOwnProperty(k) && function() {
							var e = f[k],
								n = t.el.querySelector("." + k);
							u[e] = n, _.on("input", n, function(t) {
								b[e] = "comment" === e ? (0, d.default)(n.value, {
									sanitize: !0
								}) : o(n.value.replace(/(^\s*)|(\s*$)/g, ""))
							})
						}();
						var w = function() {
						...
						var O = function() {
								...
								l.at = "", l.rid = "", l.rmail = "", b.nick = "Anonymous", w()
							},
							...
							$ = function(e) {
								...
								if (b.nick = "" == b.nick ? "Anonymous" : b.nick, b.comment.indexOf(l.at) > -1 && "" != l.at) {
									var n = '<a class="at" href=\'#' + l.rid + "'>" + l.at + "</a>";
									b.comment = b.comment.replace(l.at, n)
								}
								var r = L.mail(b.mail),
									i = L.link(b.link);
								b.mail = r.k ? r.v : "", b.link = i.k ? i.v : "", t.notify || t.verify ? M(C) : C()
							},
							A = function() {
								var e = new t.v.ACL;
								...
								n.setACL(A()), n.save().then(function(e) {
									...
									try {
										n ? (i = Number(n.innerText) + 1, n.innerText = i) : t.el.querySelector(".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments, r(e), b.mail && E({
											username: b.nick,
											mail: b.mail
										}), l.at && l.rmail && t.notify && T({
											username: l.at.replace("@", ""),
											mail: l.rmail
			...
			(function() {
				...
				function u(e, n, r) {
					if (r || "function" == typeof n) {
						...
						if (delete n.highlight, !l) return p();
						for (; d < a.length; d++) ! function(e) {
							"code" !== e.type ? --l || p() : s(e.text, e.lang, function(t, n) {
								return t ? p(t) : null == n || n === e.text ? --l || p() : (e.text = n, e.escaped = !0, void(--l || p()))
							})
						}(a[d])
					} else try {
				...
				d.bullet = /(?:[*+-]|\d+\.)/, d.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, d.item = l(d.item, "gm")(/bull/g, d.bullet)(), d.list = l(d.list)(/bull/g, d.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + d.def.source + ")")(), d.blockquote = l(d.blockquote)("def", d.def)(), d._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", d.html = l(d.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, d._tag)(), d.paragraph = l(d.paragraph)("hr", d.hr)("heading", d.heading)("lheading", d.lheading)("blockquote", d.blockquote)("tag", "<" + d._tag)("def", d.def)(), d.normal = c({}, d), d.gfm = c({}, d.normal, {
					...
					paragraph: /^/,
					heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/
				}), d.gfm.paragraph = l(d.paragraph)("(?!", "(?!" + d.gfm.fences.source.replace("\\1", "\\2") + "|" + d.list.source.replace("\\1", "\\3") + "|")(), d.tables = c({}, d.gfm, {
					nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
					table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
					...
					for (var r, i, o, a, l, s, c, u, p, e = e.replace(/^ +$/gm, ""); e;)
						...
						for (e = e.substring(o[0].length), a = o[2], this.tokens.push({
								type: "list_start",
								ordered: a.length > 1
							}), o = o[0].match(this.rules.item), r = !1, p = o.length, u = 0; u < p; u++) s = o[u], c = s.length, s = s.replace(/^ *([*+-]|\d+\.) +/, ""), ~s.indexOf("\n ") && (c -= s.length, s = this.options.pedantic ? s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + c + "}", "gm"), "")), this.options.smartLists && u !== p - 1 && (l = d.bullet.exec(o[u + 1])[0], a === l || a.length > 1 && l.length > 1 || (e = o.slice(u + 1).join("\n") + e, u = p - 1)), i = r || /\n\n(?!\s*$)/.test(s), u !== p - 1 && (r = "\n" === s.charAt(s.length - 1), i || (i = r)), this.tokens.push({
				...
				p._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/, p._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, p.link = l(p.link)("inside", p._inside)("href", p._href)(), p.reflink = l(p.reflink)("inside", p._inside)(), p.normal = c({}, p), p.pedantic = c({}, p.normal, {
		...
		function u(e, t) {
			...
			if (t.singleton) {
				var c = b++;
				n = m || (m = l(t)), r = d.bind(null, n, c, !1), i = d.bind(null, n, c, !0)
			} else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = s(t), r = h.bind(null, n, t), i = function() {
				a(n), n.href && URL.revokeObjectURL(n.href)
			}) : (n = l(t), r = p.bind(null, n), i = function() {
				a(n)
			});
			return r(e),
				function(t) {
